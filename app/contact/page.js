...
export default function Contact() {
  return (
    <div className="min-h-screen flex flex-col md:flex-row relative overflow-hidden">
      ...
      {/* Left panel */}
      <div className="flex w-full md:w-1/2 bg-emerald-600 text-white items-center justify-center px-8 pt-24 pb-12 md:py-12 md:p-12">
      ...
      {/* Right panel */}
      <div className="w-full md:w-1/2 flex items-center justify-center bg-gray-100 px-4 py-12 sm:p-8">
